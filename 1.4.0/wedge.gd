...
# --- WEDGE DEFINITION (Typically 1x1) ---
# Even though it's a slope, it usually occupies just one grid cell.
...
func _ready():
	...
	print("🔺 WEDGE: Looking for signals on:", parent)
...
func _on_dropped(_by):
	...
	print("🔺 WEDGE: ✋ RELEASED (Calculating Snap...)")
	var obj = get_parent()
	...
	# 5. Snap the CENTER (Handles Even vs Odd dimensions automatically)
	...
	# Ensure shape_type is distinct for visual reconstruction if needed
	...
	print("🔺 WEDGE: 🔒 SNAPPED & LOCKED at ", snapped_center)

# --- HELPER FUNCTIONS (Identical to Brick Script) ---
